              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    "오늘 운동은 뭐해야지?" 더이상 고민할 필요가 없습니다. ai를
                    통해 루틴을 짜고 계획달성 여부를 간편히 기록하여 사람들과
                    소통해보세요.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div
                  ...
                  style={{ backgroundColor: "#e1eff1", color: "#6ca7af" }}
                >
                  Features
                </div>
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  Our AI-powered platform provides personalized health routines,
                  intelligent recommendations, and a supportive community.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    사용자의 데이터 분석 및 자유로운 대화 형식으로 까다로운
                    요구사항도 반영한 최적의 운동루틴을 간편히 만들 수 있습니다.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    계획이 세워진 날엔 해당일의 운동루틴을 잘 수행하였는지
                    체크할 수 있습니다. 추후 얼마나 목표를 달성했는지
                    확인해보세요.
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    원하는 회원과 친구를 맺을 수 있습니다. 커뮤니티 기능을 통해
                    자유롭게 각자의 운동기록 및 루틴을 공유하고 의견을
                    나눠보세요.
                  </p>
                </div>
              </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  원하는 사항을 자유롭게 입력만 하면 됩니다. 가령 홈트레이닝,
                  헬스장 등 장소를 섞거나 집중하고 싶은 부분, 특이사항 등을
                  편하게 입력해보세요.
                </p>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
                  바디플랜을 통해 성공적으로 운동루틴을 수행중인 사람들의
                  이야기들
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-3">
              <div className="flex flex-col justify-between space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    "헬스장과 홈 트레이닝 두 장소 번갈아가면서 수행할 수 있도록
                    계획을 짜줘서 편했어요"
                  </p>
                </div>
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    "친구의 운동기록을 보거나 저의 운동기록을 공유해서 서로간의
                    피드백을 통해 방향을 잘 잡을 수 있어 좋네요"
                  </p>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="rounded-full bg-muted">
              ...
              <div className="flex flex-col justify-between space-y-4 rounded-lg border bg-background p-6 shadow-sm">
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    "까다로운 요구사항도 반영해줘서 좋고 무엇보다 루틴관리 및
                    커뮤니티 기능이 매우 맘에 들었어요!"
                  </p>
                </div>
                <div className="flex items-center space-x-4">
